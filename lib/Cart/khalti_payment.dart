...
class KhaltiPaymentPage extends StatefulWidget {
  ...
  const KhaltiPaymentPage({Key? key, required this.amount , required this.contact_number}) : super(key: key);
...
class _KhaltiPaymentPageState extends State<KhaltiPaymentPage> {
  ...
  getAmt() {
    return int.parse(amountController.text) * widget.amount; // Converting to paisa
  }
